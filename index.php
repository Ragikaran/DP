      ...
      <tbody>
        <?php 
          ...
          while($row = mysqli_fetch_assoc($result)){
            ...
            <td>". $row['name'] . "</td>
            <td>". $row['id_no'] . "</td>
            <td> <button style='border-color:black' class='edit btn btn-sm btn-primary' id=".$row['sno'].">Edit</button> <button style='background-color:red; border-color:black' class='delete btn btn-sm btn-primary' id=d".$row['sno'].">Delete</button>  </td>
          </tr>";
        } 
          ?>
