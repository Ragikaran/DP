                             ...
                             $html.="
                                        ...
                                        <div class='container' style='text-align:left; border:2px dotted black;'>
                                              ...
                                              <div class='container-2'>
                                                  ...
                                                  <div class='box-2'>
                                                      <h2>$name</h2>
                                                      <p style='font-size: 14px; color: black'>Member</p>
                                                  </div>
                                                  <div class='box-3'>
                                                      <!---->
                                                  </div>
                                              ...
                                              <div class='container-3'>
                                                  ...
                                                  <div class='info-4'>
                                                      <div class='sign'>
                                                          <br>
                                                          <p style='font-size:12px;    margin-bottom: 8px;'>Angajan ramanathan MP Jaffna District</p>
  ...
  <div class="col-sm-6">
    <div class="card jumbotron">
      <div class="card-body">
        ...
        <small id="emailHelp" class="form-text text-muted">Every member's should have unique Id no.</small>
        <br>
